package king.m.color.stepcount.step.utils;
...
public class DbUtils {
     ...
     * @return
     */
    public static <T> List<T> getQueryByWhere(Class<T> cla, String today, String[] value) {
        return liteOrm.<T>query(new QueryBuilder(cla).where(today + "=?", value));
    }
